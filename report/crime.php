<!-- Begin Page Content -->
 ...
 <td>".$row['date']."</td>
 <td>
 <a href='read-crime.php?id=". $row['id'] ."' title='View Record' data-toggle='tooltip'><span class='fa faeye'></span></a>
 <a href='updatecrime.php?id=". $row['id'] ."' title='View Record' data-toggle='tooltip'><span class='fa fa-pen'></span></a>
 </td>
 </tr> ";
 }
 ?>
