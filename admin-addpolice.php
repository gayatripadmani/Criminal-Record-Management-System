                ...
                <div class="col-sm-12">
                    <div class="row">
                        ...
                        <div class="col-sm-6 form-group">
                            ...
                            <input type="text" placeholder="Enter Police Station Here.." class="form-control"  name="polisestation" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6 form-group">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6 ">
                            <label>NID</label>
                            <input type="text" placeholder="Enter NID Here.." class="form-control" name="pNumber" required>
                        </div>
                        <div class="form-group col-sm-6 ">
                            <label>Date</label>
    ...
    if (isset($_POST['addpolice'])) {
        ...
        // Upload file to server
            if(move_uploaded_file($_FILES["image"]["tmp_name"], $targetFilePath)){ 
                ...
                $insert = $db->query("INSERT INTO police(fName,lName,height,weight,eayColor,address,city,state,zipCode,poneNumber,dateOFbirth,email,website,jobid,polisestation,image,uploads_on)VALUES('$fname','$lname','$height','$weight','$ecolor','$address','$city','$state','$zip','$phone','$date','$email','$web','$jobId','$PoliceStation','$targetFilePath',NOW())");
